...
module Encoder(
    ...
    reg [31:0] nextState;
	 ...
	 //  					     Clock
	 // *******************************************
	 always@(posedge clk, posedge BTN)
	 begin
			 if (BTN == 1'b1) begin
				 curState <= "idle";
				 EncOut <= 5'b00000;
			 ...
			 // note: when it reaches the left most and right most numbers, it does not wrap around to the other side, i.e. when "add" and it becomes >10011, it stays at 10011
			 else begin
