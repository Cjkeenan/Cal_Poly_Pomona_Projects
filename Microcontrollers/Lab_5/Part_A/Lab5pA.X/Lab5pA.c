...
void main()
{
    ...
    while(1)
    {
        ...
        Volts = (STEP * 4.0) / 1000.0;			// Temp in V = Step * 4mV per step / 1000 mV per Volt
...
void Do_Display(float V)
{
    ...
    U_value = (int)(V);						//Since the voltage is less than 10, upper value truncated by int will give the ones place
