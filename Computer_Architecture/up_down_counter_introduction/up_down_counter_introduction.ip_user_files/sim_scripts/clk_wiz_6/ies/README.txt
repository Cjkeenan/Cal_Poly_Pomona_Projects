...
#
# Generated by export_simulation on Fri Sep 13 18:14:35 -0700 2019
#
################################################################################
...
'-reset_run' switch to the './clk_wiz_6.sh' script.

./clk_wiz_6.sh -reset_run
...
./clk_wiz_6.sh -noclean_files

For more information on the script, please type './clk_wiz_6.sh -help'.
